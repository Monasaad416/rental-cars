    ...
    <div className={`row`}>
      <div className="col-12">
        <div className="container">
          <div className="row">
            <div className={`col-md-8 mt-md-5 mt-3 pt-md-5 ${styles.apps_bg}`}>
              <h2>
              ...
              <form action="">
                <div className="input-group mb-3" style={{ width: "360px" }}>
                  <input
                    type="text"
                    className={`form-control  ${styles.info}`}
                    placeholder="Name"
                  />
                </div>
                <div className="input-group mb-3" style={{ width: "360px" }}>
            ...
            <div className="col-md-4">
              <div className={`d-flex justify-content-end align-items-end d-md-block d-none mb-0`}>
                <img src={iphone} alt="iphone" style={{ width:"80%" }} />
              </div>
            </div>
          </div>
        </div>
